...
public class MenageTest {
    ...
    public void testCreationMenage() {
        Menage m = new Menage("Famille Martin", "12 rue des Lilas", "martin@mail.com", "azerty", 1234, null);
        System.out.println("Test création Ménage : " + m.getNom());
    }

    public void testDepotAvecPoints() {
        // Création du ménage
        Menage m = new Menage("Famille Durand", "8 rue Bleue", "durand@mail.com", "1234", 5678, null);
    ...
    public void testDepotAccesRefuse() {
        Menage m = new Menage("Famille Refusée", "Rue Barrée", "refus@mail.com", "pass", 9999, null);
